...
function AboutUs() {
  return (
    <div className="container max-w-8xl mx-auto px-10">
      <div className="py-16 h-fit lg:min-h-screen">
        <div className="container  mx-auto">
          <div className="flex flex-col gap-10 lg:flex-row items-center justify-center">
            ...
            <div className="lg:w-1/2 w-full">
              <h5 className="text-2xl font-semibold text-[#ff601c]">About Us</h5>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="flex items-center border-l-4 border-[#ff601c] pl-4">
                  <h1 className="flex-shrink-0 text-4xl text-[#ff601c] mb-0">
                    15
                  </h1>
                  <div className="pl-4">
              ...
              <a
                className="btn rounded-lg bg-[#ff601c] text-white py-3 px-6 mt-2 inline-block"
                href=""
              >
                Read More
              </a>
