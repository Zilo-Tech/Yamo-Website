...
function ServiceCard({ title, desc, AwesomeIcon }) {
  return (
    <div className="service-item max-w-[95%] sm:max-w-[98%] lg:w-full  mx-auto h-72  flex flex-col items-center rounded-lg pt-3 bg-white border shadow group hover:bg-orange-500 transition-all duration-300 ease-in-out">
